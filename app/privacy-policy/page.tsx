  ...
  return (
    <LegalPage title="Privacy Policy" updated="September 20, 2026">
      ...
      <section>
        ...
        <p className="mt-2">
          We use your information to operate the platform, including tuition matching, manual account
          verification, notifications, admin support, and donation-payment records. Contact details are
          restricted so students and tutors cannot directly access one another's phone or WhatsApp information.
      ...
      <section>
        ...
        <p className="mt-2">
          ...
          authentication with short-lived access tokens and rotating refresh tokens. Verification
          information is reviewed manually by authorized Progoti Shikkha administrators. We use
          input validation, rate limiting, and encrypted connections.
        </p>
      </section>
      <section>
